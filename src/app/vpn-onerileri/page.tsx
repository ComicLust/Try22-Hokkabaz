...
export default async function VpnOnerileriPage() {
  ...
  const items = [
    {
      name: 'Cloudflare WARP (Ücretsiz)',
      description:
        'Cloudflare’ın WARP uygulaması, bağlantınızı optimize ederek birçok kısıtlı içeriğe erişimi kolaylaştıran, ücretsiz bir çözüm sunar. Masaüstü ve mobil uygulamaları mevcuttur.',
      href: 'https://one.one.one.one/warp/',
      features: ['Ücretsiz', 'Hızlı kurulum', 'Windows/macOS/iOS/Android desteği'],
    },
    {
      name: 'ProtonVPN Free',
      description:
        'ProtonVPN’in ücretsiz planı, temel VPN ihtiyaçları için güvenilir bir alternatiftir. Sınırlı hız ve lokasyon olsa da Türkiye’den erişimde çoğu senaryoda yeterlidir.',
      href: 'https://protonvpn.com/',
      features: ['Ücretsiz plan', 'Güvenilir altyapı', 'Çoklu platform desteği'],
    },
  ]
