      ...
      <main className="pt-3 md:pl-72">
        <div className="container mx-auto px-4 py-6 space-y-6">
          ...
          <section className="space-y-3">
            ...
            <p className="text-foreground/80">Gizlilikle ilgili sorularınız için <a href="mailto:privacy@hokkabaz.net" className="text-gold">privacy@hokkabaz.net</a> veya <a href="mailto:info@hokkabaz.net" className="text-gold">info@hokkabaz.net</a> adreslerine yazabilirsiniz.</p>
          </section>
