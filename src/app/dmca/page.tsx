      ...
      <main className="pt-3 md:pl-72">
        <div className="container mx-auto px-4 py-6 space-y-6">
          ...
          <section className="space-y-3">
            ...
            <p className="text-foreground/80">Bildiriminizi <a href="mailto:dmca@hokkabaz.net" className="text-gold">dmca@hokkabaz.net</a> adresine gönderebilirsiniz.</p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p className="text-foreground/80">DMCA ve telif hakları ile ilgili tüm talepler için: <a href="mailto:dmca@hokkabaz.net" className="text-gold">dmca@hokkabaz.net</a></p>
          </section>
        </div>
      </main>
      <Footer />
