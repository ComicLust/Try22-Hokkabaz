            ...
            <Card className="bg-neutral-950/60 border-yellow-500/20 lg:col-span-2">
              <CardHeader className="pb-3">
                <CardTitle className="flex items-center justify-between">
                  ...
                  <span className="text-xs sm:text-sm text-neutral-400">Admin: @GmanVibes</span>
                </CardTitle>
              </CardHeader>
              <CardContent>
                  ...
                  <AlertDialog>
                    <AlertDialogTrigger asChild>
                      <Button className="telegram-gradient neon-button">
                        <TelegramIcon className="w-4 h-4 mr-2" /> Telegram’da Admin’e Yaz (@GmanVibes)
                      </Button>
                    </AlertDialogTrigger>
                    <AlertDialogContent className="bg-neutral-950 border border-yellow-500/20">
                      ...
                      <AlertDialogFooter>
                        ...
                        <AlertDialogAction onClick={() => window.open('https://t.me/GmanVibes', '_blank', 'noopener,noreferrer')}>Evet, işbirliği için yazıyorum</AlertDialogAction>
                      </AlertDialogFooter>
                    </AlertDialogContent>
                  </AlertDialog>
              ...
              <CardContent>
                <div className="flex items-center gap-3">
                  <Avatar className="size-12">
                    <AvatarImage src="" alt="GmanVibes" />
                    <AvatarFallback className="text-lg bg-yellow-500/20 text-yellow-300">GV</AvatarFallback>
                  </Avatar>
                  <div>
                    ...
                    <AlertDialog>
                      <AlertDialogTrigger asChild>
                        <button className="text-yellow-300 text-sm hover:text-yellow-200">@GmanVibes</button>
                      </AlertDialogTrigger>
                      <AlertDialogContent className="bg-neutral-950 border border-yellow-500/20">
                        <AlertDialogHeader>
                          <AlertDialogTitle>Yalnızca işbirliği ve sponsorluk</AlertDialogTitle>
                        ...
                        <AlertDialogFooter>
                          <AlertDialogCancel>İptal</AlertDialogCancel>
                          <AlertDialogAction onClick={() => window.open('https://t.me/GmanVibes', '_blank', 'noopener,noreferrer')}>Onayla ve devam et</AlertDialogAction>
                        </AlertDialogFooter>
                      </AlertDialogContent>
                    </AlertDialog>
                  </div>
          ...
          <div className="mt-12 text-center">
            <AlertDialog>
              ...
              <AlertDialogContent className="bg-neutral-950 border border-yellow-500/20">
                ...
                <AlertDialogFooter>
                  <AlertDialogCancel>İptal</AlertDialogCancel>
                  <AlertDialogAction onClick={() => window.open('https://t.me/GmanVibes', '_blank', 'noopener,noreferrer')}>Evet, işbirliği için</AlertDialogAction>
                </AlertDialogFooter>
              </AlertDialogContent>
            </AlertDialog>
